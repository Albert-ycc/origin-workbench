...
const (
	...
	EventMeetingTranscriptSegmentUpdated = "meeting:transcript_segment_updated"
	EventMeetingTranscriptSegmentDeleted = "meeting:transcript_segment_deleted"
	EventMeetingASRJobUpdated            = "meeting:asr_job_updated"
