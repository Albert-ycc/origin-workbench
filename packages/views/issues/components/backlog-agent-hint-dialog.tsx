      ...
      <div className="px-5 pb-4 pt-5">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 text-sm leading-5 text-muted-foreground">
              这个任务暂时停放在待整理中，分配的智能体会等待。准备开始时，把它移动到待办即可。
            </p>
          </div>
        </div>
        ...
        <div className="mt-4 grid gap-2 rounded-lg border bg-muted/35 p-3 text-sm">
          <div className="flex items-center gap-2 text-muted-foreground">
            ...
            <span className="font-medium text-foreground">待整理</span>
            <span className="text-muted-foreground">会让智能体保持暂停</span>
          </div>
          <div className="flex items-center gap-2 text-muted-foreground">
            <ArrowRight className="size-4 shrink-0" />
            <span className="font-medium text-foreground">待办</span>
            <span className="text-muted-foreground">会启动智能体</span>
