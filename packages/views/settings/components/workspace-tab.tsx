...
export function WorkspaceTab() {
  ...
  const handleLeaveWorkspace = () => {
    ...
    setConfirmAction({
      title: "离开工作区",
      description: `离开 ${workspace.name}？重新邀请前，你将无法访问这个工作区。`,
      variant: "destructive",
      onConfirm: async () => {
        setActionId("leave");
    ...
    <div className="space-y-8">
          ...
          <CardContent className="space-y-3">
            ...
            <div>
              ...
              <Textarea
                ...
                disabled={!canManageWorkspace}
                className="mt-1 resize-none"
                placeholder="给这个工作区里的 AI 智能体使用的背景信息和上下文"
              />
            </div>
            <div>
              <Label className="text-xs text-muted-foreground">地址标识</Label>
      ...
      <section className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-sm font-semibold">危险区</h2>
        </div>
