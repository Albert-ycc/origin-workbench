      ...
      <InviteShell onBack={onBack}>
        <Card className="w-full max-w-md">
          <CardContent className="flex flex-col items-center gap-4 py-12">
            ...
            <h2 className="text-lg font-semibold">未找到邀请</h2>
            <p className="text-sm text-muted-foreground text-center">
              这个邀请可能已过期、已撤销，或不属于当前账号。
            </p>
      ...
      <InviteShell onBack={onBack}>
        <Card className="w-full max-w-md">
          <CardContent className="flex flex-col items-center gap-4 py-12">
            ...
            <h2 className="text-lg font-semibold">你已加入 {invitation.workspace_name}！</h2>
      ...
      <InviteShell onBack={onBack}>
        <Card className="w-full max-w-md">
          <CardContent className="flex flex-col items-center gap-4 py-12">
            ...
            <p className="text-sm text-muted-foreground">你不会被加入这个工作区。</p>
            <Button variant="outline" onClick={() => push(fallbackDest)}>
              前往工作台
            </Button>
          </CardContent>
        ...
        <CardContent className="flex flex-col items-center gap-6 py-12">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              邀请你以{invitation.role === "admin" ? "管理员" : "成员"}身份加入。
            </p>
          </div>

          {isAlreadyHandled ? (
            <div className="text-sm text-muted-foreground">
              这个邀请已经处理过：{invitation.status}。
            </div>
          ) : isExpired ? (
            <div className="text-sm text-muted-foreground">
              这个邀请已过期。
